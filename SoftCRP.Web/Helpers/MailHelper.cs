...
namespace SoftCRP.Web.Helpers
{
    public class MailHelper : IMailHelper
    {
        ...
        public void SendMailAttachmentFileTramite(string to, string subject, string body, List<ArchivoTramites> files)
        {
            var from = _configuration["Mail:From"];
            var smtp = _configuration["Mail:Smtp"];
            var port = _configuration["Mail:Port"];
        ...
        public void SendMailAttachmentFileAnalisis(string to, string subject, string body, List<ArchivoAnalisis> files)
        {
            var from = _configuration["Mail:From"];
            var smtp = _configuration["Mail:Smtp"];
            var port = _configuration["Mail:Port"];
