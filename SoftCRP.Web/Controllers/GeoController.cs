...
namespace SoftCRP.Web.Controllers
{
    ...
    public class GeoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (!string.IsNullOrEmpty(this.User.Identity.Name))
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        vehiculosGps = _vehiculoGpsRepository.GetVehiculosGPSPositionAsync(DateTime.Now.Day, DateTime.Now.Month, DateTime.Now.Year, user.Cedula, "").ToList();
                        graficosViewModel.ClienteId = user.Cedula;
                    }
                    else if (this.User.IsInRole("Admin") || this.User.IsInRole("Renting"))
                    {
                        vehiculosGps = _vehiculoGpsRepository.GetVehiculosGPSPositionAsync(DateTime.Now.Day, DateTime.Now.Month, DateTime.Now.Year, "", "").ToList();
                    }
                }
            }
        ...
        public async Task<JsonResult> GetMapaCliente(string UserId)
        {
            ...
            var vehiculosGps = _vehiculoGpsRepository.GetVehiculosGPSPositionAsync(DateTime.Now.Day, DateTime.Now.Month, DateTime.Now.Year, UserId, "");
        ...
        public async Task<JsonResult> GetMapaAll(string UserId)
        {
            ...
            var vehiculosGps = _vehiculoGpsRepository.GetVehiculosGPSPositionAsync(DateTime.Now.Day, DateTime.Now.Month, DateTime.Now.Year, "", "");
        ...
        public async Task<JsonResult> GetMapaClientePlaca(string UserId, string Placa)
        {
            ...
            var vehiculosGps = _vehiculoGpsRepository.GetVehiculosGPSPositionAsync(DateTime.Now.Day, DateTime.Now.Month, DateTime.Now.Year, UserId, Placa);
